...
/**
 * The Lab4 program reads integers from file and sort in LinkList.
 *
 * @author Ai Sun
 * @version 1.0
 */
public class Lab4 {
    /**
     * The main method reads integers from file and display the sorted LinkList.
...
class LinkedList
{
    ...
    public String toString()
    {
        ...
        Node p = first;
        final String MSG = "Linked list contents:\n";
