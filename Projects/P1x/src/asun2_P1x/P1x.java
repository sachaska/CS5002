...
/**
 * The P1x program implements an application that letting user plays custom
...
public class P1x {
    ...
    /**
     * The main method create custom size TicTacToe board for the game, play
     * the game and display game results, let player repeat the game as they
     * want.
     *
    ...
    public static void main(String[] args) {
        ...
        TicTacToe tic = new TicTacToe(getSize(keyboard));
        do {
    ...
    /**
     * The getSize method prompts user for game board size. The size value is
     * returned.
     *
     * @param keyboard A Scanner object for capturing user input.
     * @return A integer value of custom board size.
     */
    public static int getSize(Scanner keyboard) {
        final String MSG = "What size of board shall we play? (3-25, odd) ";
        int size;
        do {
            System.out.print(MSG);
            size = keyboard.nextInt();
        } while (size > 25 || size < 3 || size%2 == 0);
        return size;
    }
    ...
    /**
     * The getWinner method gets the game winner.
     *
     * @param tic TicTacToe Object of the game.
     * @param keyboard A Scanner object for capturing user input.
